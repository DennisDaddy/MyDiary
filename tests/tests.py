...
class EntryTestCase(unittest.TestCase):
    ...
    def test_login(self):
        tester = app.test_client(self)
        response = tester.post('/diary/api/v1/auth/login', json={'username' : 'dennis', 'password': 'secret'})
    ...
    def test_register(self):
        tester = app.test_client(self)
        response = tester.post('/diary/api/v1/auth/register', json={'username': 'dennis','email': 'de@gmail.com',
